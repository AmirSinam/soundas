...
///
/// Instead the cache name carries the build, and `bfebd416c5f3` is replaced with
...
///
const CACHE = 'soundas-bfebd416c5f3';

/// Caching is switched off entirely when the app is served locally.
///
/// `bfebd416c5f3` is only ever replaced at deploy time, so a local run has one
